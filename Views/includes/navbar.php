  ...
  <nav class="navbar">
    <div class="navbar-content">
      ...
      <div class="nav-item active"><span>Inicio</span></div>
        ...
        <div class="nav-item contacto">
          <span class="icon-contacto">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" fill="currentColor" viewBox="0 -2 16 16">
        ...
        <div class="nav-item iniciar-sesion">
          <span class="icon-iniciar">
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="70" fill="currentColor" viewBox="2 1 12 11">

...
<body>
    ...
    <div class="floating-buttons" style="flex-direction: column; gap: 48px;">
        <a href="index.php?action=listarUsuarios" class="floating-button" title="Gestionar usuarios" style="background:#468704; margin-bottom:75px;">
        ...
        <form action="index.php" method="GET">
            ...
            <button type="submit" class="floating-button" title="Crear publicación">
